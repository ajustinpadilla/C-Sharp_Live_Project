...
namespace TheatreCMS.Areas.Subscribers.Controllers
{
    public class SeasonManagerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NumberSeats,BookedCurrent,FallProd,FallTime,BookedFall,WinterProd,WinterTime,BookedWinter,SpringProd,SpringTime,BookedSpring")] SeasonManager seasonManager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NumberSeats,BookedCurrent,FallProd,FallTime,BookedFall,WinterProd,WinterTime,BookedWinter,SpringProd,SpringTime,BookedSpring")] SeasonManager seasonManager)
        {
            if (ModelState.IsValid)
            {
